...
from botterLib import botter

suchbegriff = input(
    'Nach welchem Suchbegriff möchten sie auf Youtube live Gaming suchen? ').lower()
...
for formatierung in endProd:
    print(formatierung)
print('\nEs sind insgesamt %i Livestreams auf Youtube Gaming live.' % len(endProd))
